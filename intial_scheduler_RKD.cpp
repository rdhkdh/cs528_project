...
int main() 
{
    ...
    /* Pending tasks:
    simulate failure due to FP,
    count no of tasks for which deadline is crossed,
    count no of tasks which fail due to FP,
    update(incr/decr) trust after every execution,
    make execution parallel by using threads
    */
